...
export default class Logo {
  constructor() {
    ...
    this.logo.position.x = posCenter;
    this.logo.position.y = param.innerRadius;
    this.logo.add(this.logoMove, this.logoKO, this.logoEN);
    this.instance.add(this.typo.hello, this.typo.descKO, this.typo.descEN);

    //this.logo.add(new THREE.AxesHelper(15));
  ...
  toEN() {
    gsap.to(this.OI.scale, {
      x: 1.4,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.young.position, {
      x: posG,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.OtopArc.rotation, {
      z: Math.PI,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.eo.scale, {
      x: 0,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.I.scale, {
      x: 0,
      duration: 0.6,
      ease: "power2.inout",
    });
    ...
    gsap.to(this.N1iLeft.scale, {
      x: 1,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.N1iRight.scale, {
      x: 1,
      duration: 0.6,
      ease: "power2.inout",
    });
  ...
  toU() {
    gsap.to(this.Uarc.rotation, {
      z: Math.PI,
      duration: 0.4,
      ease: "power2.inout",
    });
    gsap.to(this.UiLeft.scale, {
      x: 1,
      duration: 1,
      ease: "power2.inout",
    });
    gsap.to(this.UiRight.scale, {
      x: 1,
      duration: 1,
      ease: "power2.inout",
    });
  ...
  toO1() {
    gsap.to(this.O1arcBottom.rotation, {
      z: Math.PI,
      duration: 0.6,
      ease: "power2.out",
    });
  ...
  toY() {
    gsap.to(this.Yarc.rotation, {
      z: Math.PI,
      duration: 0.4,
      ease: "power2.inout",
    });
    gsap.to(this.YiLeft.scale, {
      x: 1,
      duration: 1,
      ease: "power2.inout",
    });
    gsap.to(this.YiRight.scale, {
      x: 1,
      duration: 1,
      ease: "power2.inout",
    });
    gsap.to(this.Ystem.scale, {
      x: 1,
      duration: 0.8,
      ease: "power2.inout",
    });
  ...
  toN() {
    gsap.to(this.N2iLeft.scale, {
      x: 1,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.N2iRight.scale, {
      x: 1,
      duration: 0.6,
      ease: "power2.inout",
    });
  ...
  toO2() {
    gsap.to(this.O2arcBottom.rotation, {
      z: Math.PI,
      duration: 0.6,
      ease: "power2.inout",
    });
  ...
  toO3() {
    gsap.to(this.O3arcBottom.rotation, {
      z: Math.PI,
      duration: 0.6,
      ease: "power2.inout",
    });
    gsap.to(this.topArc.rotation, {
      z: Math.PI / 2,
      duration: 0.8,
      ease: "power2.inout",
      delay: 0.3,
    });
    gsap.to(this.bottomArc.rotation, {
      z: Math.PI / 2,
      duration: 0.8,
      ease: "power2.inout",
      delay: 0.3,
  ...
  transfrom() {
    if (!this.done) {
      gsap.to(this.logoMove.position, {
        x: posS,
        duration: 2.4,
        ease: "sine.inout",
      });
      gsap.to(this.logo.position, {
        x: -posY,
        duration: 2.4,
        ease: "sine.inout",
      });
